...
## How to use
1. Build the image by copying this Dockerfile to a new folder on the target SBC, then run `docker build -t "steelhead-lyrical:<version>" . 2>&1 | tee build.log`. `<version>` convention is MAJOR.MINOR.BUGFIX-ARCH, e.g. `1.0.0-amd64`
