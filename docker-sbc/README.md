...
## How to use
1. From the root of the repository, build the image by running `docker build -f docker-sbc/Dockerfile -t "steelhead-lyrical:<version>" . 2>&1 | tee build.log`. `<version>` convention is MAJOR.MINOR.BUGFIX-ARCH, e.g. `1.0.0-amd64`
