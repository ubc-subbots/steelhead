...
def generate_launch_description():
    ...
    underwater_camera = Node(
        ...
        parameters=[
            ...
            {
                "spectral_sensitivity_blue": params["spectral_sensitivity"][
                    camera_type
                ][0]
            },
            {
                "spectral_sensitivity_red": params["spectral_sensitivity"][camera_type][
                    1
                ]
            },
            {
                "spectral_sensitivity_green": params["spectral_sensitivity"][
                    camera_type
                ][2]
            },
            {
                "illumination_irradiance": params["illumination_irradiance"][
                    irradiance_type
                ]
            },
        ],
