...
all_bodies = (
    body_1  # Replace "body_1" by "body_1 + body_2 + body_3" for multibody problem.
)

all_bodies = (
    all_bodies.immersed_part()
)  # if your mesh has panels above the free surface, remove them
...
test_matrix = xr.Dataset(
    {
        "omega": np.linspace(
            0.1, 2.0, 20
        ),  # Can also specify "freq" (in Hz), "period", "wavelength" or "wavenumber"
