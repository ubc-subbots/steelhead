...
To launch the `spiderfish_pid_controller` node, use the following command

    ros2 launch spiderfish_pid_controller spiderfish_pid_controller_launch.py
...
- `spiderfish_pid_controller` : A simple PID controller for the movement of the AUV in x, y, z, and yaw. 
