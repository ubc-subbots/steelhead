#ifndef STEELHEAD_VISION__POLE_FEATURIZER
#define STEELHEAD_VISION__POLE_FEATURIZER
...
#include "steelhead_vision/contour_features.hpp"
...
{
private:
  steelhead_vision::ContourFeatures cnt_features;

public:
  PoleFeaturizer()
  {
    cnt_features = steelhead_vision::ContourFeatures();
  }
...
#endif  // STEELHEAD_VISION__POLE_FEATURIZER
