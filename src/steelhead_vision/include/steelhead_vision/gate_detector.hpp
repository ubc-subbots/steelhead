#ifndef STEELHEAD_VISION__GATE_DETECTOR
#define STEELHEAD_VISION__GATE_DETECTOR
...
#include "steelhead_vision/pole_featurizer.hpp"
#include "steelhead_vision/object_detector.hpp"
#include "steelhead_interfaces/msg/object_offset.hpp"
#include "geometry_msgs/msg/pose_stamped.hpp"

namespace steelhead_vision
{
class GateDetector : public rclcpp::Node, public steelhead_vision::ObjectDetector
{
public:
...
private:
  ...
  steelhead_vision::PoleFeaturizer featurizer_;
...
RCLCPP_COMPONENTS_REGISTER_NODE(steelhead_vision::GateDetector)

#endif  // STEELHEAD_VISION__GATE_DETECTOR