#include <string> 
#include "steelhead_vision/gate_detector.hpp"
...
using namespace steelhead_vision;
...
{
  vector<vector<Point>> pole_hulls;
  Ptr<SVM> svm = SVM::load("/home/dson/steelhead/src/steelhead_vision/config/accuracy_opencv_model.xml");
  vector<float> y_hat;
