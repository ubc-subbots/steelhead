...
namespace triton_controls
{
    ...
    class QualifyingTask : public rclcpp::Node
    {
    ...
    public:
         ...
         */
        explicit QualifyingTask(const rclcpp::NodeOptions & options);
    ...
    private:
        ...
        rclcpp::Publisher<geometry_msgs::msg::Wrench>::SharedPtr input_forces_publisher_;
...
RCLCPP_COMPONENTS_REGISTER_NODE(triton_controls::QualifyingTask)
