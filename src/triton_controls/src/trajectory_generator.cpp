  ...
  void TrajectoryGenerator::state_callback(const nav_msgs::msg::Odometry::SharedPtr msg)
  {
    ...
    if (_start == true)
    {
      ...
      // turn around when the detection makes no sense. 
      {
        ...
        stop_msg.pose.orientation.x = 0.0;
        stop_msg.pose.orientation.y = 0.0;
        stop_msg.pose.orientation.z = 0.0;
        stop_msg.pose.orientation.w = 1.0;
        stop_msg.distance.position.x = 0.0;
        stop_msg.distance.position.y = 0.0;
        stop_msg.distance.position.z = 0.0;
        stop_msg.distance.orientation.x = 0.0;
        stop_msg.distance.orientation.y = 0.0;
        stop_msg.distance.orientation.z = 0.0;
        stop_msg.distance.orientation.w = 1.0;
        stop_msg.duration = 2; // or your preferred duration
