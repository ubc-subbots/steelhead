...
def generate_launch_description():
    ...
    # Simple gate navigator for straight-line gate navigation
    straight_gate_navigator = Node(
        name='simple_gate_navigator',
        namespace='/triton/controls',
        package='triton_controls',
        executable='simple_gate_navigator',
        output='screen',
        parameters=[{'use_sim_time': True}]
    )
    ...
    ld.add_action(straight_gate_navigator)
